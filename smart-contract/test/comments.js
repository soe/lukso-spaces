...
describe("When using Custom LSP7", function () {
  ...
  it("should removeComment", async function () {
    ...
    await lsp7Contract.connect(commentor).createComment(postId, 'QmbWqxBEKC3P8tqsKc98xmWNzrzDtRLMiMPL8wBuTGsMnR');
    await lsp7Contract.connect(commentor).createComment(postId, 'QmbWqxBEKC3P8tqsKc98xmWNzrzDtRLMiMPL8wBuTGsMnR');
    await lsp7Contract.connect(commentor).createComment(postId, 'QmbWqxBEKC3P8tqsKc98xmWNzrzDtRLMiMPL8wBuTGsMnR');
    await lsp7Contract.connect(commentor).createComment(postId, 'QmbWqxBEKC3P8tqsKc98xmWNzrzDtRLMiMPL8wBuTGsMnR');
    await lsp7Contract.connect(commentor).createComment(postId, 'QmbWqxBEKC3P8tqsKc98xmWNzrzDtRLMiMPL8wBuTGsMnR');
    ...
    const postId10 = 10
    await lsp7Contract.connect(commentor).createComment(postId10, 'QmbWqxBEKC3P8tqsKc98xmWNzrzDtRLMiMPL8wBuTGsMnR');
    await lsp7Contract.connect(commentor).createComment(postId10, 'QmbWqxBEKC3P8tqsKc98xmWNzrzDtRLMiMPL8wBuTGsMnR');
    await lsp7Contract.connect(commentor).createComment(postId10, 'QmbWqxBEKC3P8tqsKc98xmWNzrzDtRLMiMPL8wBuTGsMnR');
    await lsp7Contract.connect(commentor).createComment(postId10, 'QmbWqxBEKC3P8tqsKc98xmWNzrzDtRLMiMPL8wBuTGsMnR');
    await lsp7Contract.connect(commentor).createComment(postId10, 'QmbWqxBEKC3P8tqsKc98xmWNzrzDtRLMiMPL8wBuTGsMnR');
